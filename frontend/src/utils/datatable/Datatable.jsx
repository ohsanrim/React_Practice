...
function Datatable(props){
    const tableRef = useRef();
     ...
     useEffect(() => {
      ...
      const table = $(tableRef.current).DataTable({
        ...
        lengthChange: false, // 표시 건수기능 숨기기
        serverSide: true,
        pageLength: 10,  // 페이징 처리를 통한 화면 표시 건 수
        bPaginate:true,
	      ordering:true,
        responsive: true, // 반응형 켜기
        ajax: props.dataTableAjax,
    ...
    return <table className="datatable" ref={tableRef} style={{ width: '100%' }}></table>;
...
//     return <table ref={ref} className style={{ width: '100%' }}></table>;
// });
